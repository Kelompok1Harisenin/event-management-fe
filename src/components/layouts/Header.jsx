...
import Auth from "../../assets/utils/helpers/auth";
// import Cookies from "js-cookie";
// import PrivateRoute from "../../assets/router/private-router";
      ...
      <div id="container" className={`grid grid-cols-7 gap-2 w-4/5 mx-auto h-full max-md:grid-cols-6 max-md:w-[95%] `}>
        ...
        <div id="header-list" className="col-span-3 text-center max-md:col-span-1 ">
          ...
          <ul id="list-event" className={`max-md:'hidden' grid grid-cols-5 max-md:${isPressed ? 'block' : 'hidden'} max-md:w-60 max-md:grid-rows-1 max-md:bg-white max-md:right-0`}>
            ...
            <li id="Log-in" className={`col-span-1 text-center py-7 hover:bg-gray-300 ${isLoggedIn ? 'hidden' : 'block'}`} onClick={handleLogin}>
              <NavLink>Log In</NavLink>
            </li>
            <li id="Sign-up" className={`col-span-1 text-center py-7 hover:bg-gray-300 ${isLoggedIn ? 'hidden' : 'block'}`}>
